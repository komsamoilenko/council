...
for (const name of ['audit','safewrite','preflight','host-json','appdirs','markers','tomlblock','manifest','journal','lock','backup','cloudsync','dialogue','report','machine','config-template']) {
