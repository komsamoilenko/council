...
module.exports = function make(id) {
  ...
  return {
    ...
    probe: asyncFail('proc'), inspect: asyncFail('proc'), isAlive: asyncFail('proc'), livenessOf: asyncFail('proc'), verifyRunner: asyncFail('proc'), verifyLeaf: asyncFail('proc'), waitForDeath: asyncFail('proc'), treeKill: asyncFail('proc'), spawnDetachedOpts: fail('proc'),
